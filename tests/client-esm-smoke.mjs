...
try {
  ...
  symlinkSync(join(project, "node_modules", "effect"), join(fixture, "node_modules", "effect"), "dir")
...
`)
  execFileSync(process.execPath, [join(fixture, "consumer.mjs")], { cwd: fixture, stdio: "inherit" })
  process.stdout.write("Client ESM smoke passed without React or assistant-ui installed.\n")
} finally {
